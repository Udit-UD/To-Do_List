    ...
    return(
        <div classNmae="container" id= "cont" style={myStyle}>
            ...
            <div className='border p-2'>
                ...
                <p>This web application is created by <i>Udit Gupta</i> as a React Based Project. 
                The sole purpose for choosing this "To-Do List Manager" is to make life of people sorted.<br/> We are so busy in our daily life so it's very difficult for us to remember our "todo-tasks". This web-app helps you to remember your all tasks on a daily basis. <br/><br /> You can follow <i>Udit</i> <a href='https://www.linkedin.com/in/udit-gupta-77906a228/'>here!</a></p>
            </div>
        </div>
    )
}
